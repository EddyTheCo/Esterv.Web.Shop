...
protected:
  Product(const quint64 price, const QString name, const QString description)
      : CoreBase{ProductType::Basic}, m_price{price}, m_name{name},
        m_description{description} {};
  Product(QByteArray id, const quint64 price, const QString name,
...
protected:
  BasicProduct(const quint64 price, const QString name,
               const QString description)
      : Product(price, name, description), CoreBase(ProductType::Basic) {}
  BasicProduct(QByteArray id, const quint64 price, const QString name,
               const QString description)
